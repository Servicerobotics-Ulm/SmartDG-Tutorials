...
#include <SmartDG.h>
#include "TransferFunctions_DComp1.h"
#include "TransferFunctions_DComp2.h"
#include "TransferFunctions_DComp3.h"
...
namespace SmartDG_GlobalFunction{
	void EnvironmentGenerator(vector <string> &SmartDependencyObjects,
		...
		TransferFunctions.emplace("DComp1", &SmartDG::TransferFunctions_DComp1::TFT);
		...
		// Attaching Transfer function to Dependency Component
		TransferFunctions.emplace("DComp2", &SmartDG::TransferFunctions_DComp2::TFT);

		// Dependency Component
		SmartComponents.push_back("DComp3");	
		Wiki["DComp3"] = "Dependency Component 3";
		// Output Port(s)
		OutputPorts["DComp3"].push_back("Out");
			// Dependency Objects handled at this output port	
			OutputObjectInstances["DComp3.Out"].push_back("DObj1");
			OutputObjectInstances["DComp3.Out"].push_back("DObj2");
		// Attaching Transfer function to Dependency Component
		TransferFunctions.emplace("DComp3", &SmartDG::TransferFunctions_DComp3::TFT);
