...
int Run(string mode, string displaymode){
	...
	DD.push_back(SmartDG::DependencyDescriptor("ConY","III","Out","DObj1","DComp1","In"));
	DD.push_back(SmartDG::DependencyDescriptor("ConY","III","Out","DObj2" ,"DComp1","In"));
	map<string, SmartDG::GUIPoint> GUI;
	GUI["III"] = SmartDG::GUIPoint("DComp1",10*(SmartDG_TAB/10),10*(SmartDG_TAB/10));
	GUI["DComp1"] = SmartDG::GUIPoint("DComp1",100*(SmartDG_TAB/10),10*(SmartDG_TAB/10));
